...
<body class="body w3-auto">
    ...
    $isAB = isset($_SESSION['POST_SAVE']["AB"]) &&
        $_SESSION['POST_SAVE']["AB"] == "AB";
    $isBC = isset($_SESSION['POST_SAVE']["BC"]) &&
        $_SESSION['POST_SAVE']["BC"] == "BC";
    $isMB = isset($_SESSION['POST_SAVE']["MB"]) &&
        $_SESSION['POST_SAVE']["MB"] == "MB";
    $isNB = isset($_SESSION['POST_SAVE']["NB"]) &&
        $_SESSION['POST_SAVE']["NB"] == "NB";
    $isNL = isset($_SESSION['POST_SAVE']["NL"]) &&
        $_SESSION['POST_SAVE']["NL"] == "NL";
    $isNS = isset($_SESSION['POST_SAVE']["NS"]) &&
        $_SESSION['POST_SAVE']["NS"] == "NS";
    $isON = isset($_SESSION['POST_SAVE']["ON"]) &&
        $_SESSION['POST_SAVE']["ON"] == "ON";
    $isPE = isset($_SESSION['POST_SAVE']["PE"]) &&
        $_SESSION['POST_SAVE']["PE"] == "PE";
    $isQC = isset($_SESSION['POST_SAVE']["QC"]) &&
        $_SESSION['POST_SAVE']["QC"] == "QC";
    $isSK = isset($_SESSION['POST_SAVE']["SK"]) &&
        $_SESSION['POST_SAVE']["SK"] == "SK";
    $isNT = isset($_SESSION['POST_SAVE']["NT"]) &&
        $_SESSION['POST_SAVE']["NT"] == "NT";
    $isNU = isset($_SESSION['POST_SAVE']["NU"]) &&
        $_SESSION['POST_SAVE']["NU"] == "NU";
    $isYT = isset($_SESSION['POST_SAVE']["YT"]) &&
        $_SESSION['POST_SAVE']["YT"] == "YT";
        ...
        <article class="w3-container w3-border-left w3-border-right
            ...
            <form id="registrationForm" action="scripts/formRegistrationResponse.php" method="post" autocomplete="on">
                ...
                <div class="w3-row">
                    ...
                    <div class="w3-threequarter w3-container">
                        <input type="text" name="firstName" required style="width: 80%;" value="<?php echo $firstNameSaved; ?>" title="Initial capital; spaces, apostrophes,&#10;and hyphens allowed" pattern="^[A-Z][A-Za-z '-]*$">
                        <span class="w3-text-red">*</span>
                    </div>
                </div>
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-threequarter w3-container">
                        <input type="text" name="middleInitial" style="width: 10%;" value="<?php echo $middleInitialSaved; ?>" title="Capital letter, followed by an optional period" pattern="^[A-Z](\.)?$">
                    </div>
                </div>
                <div class="w3-row">
                    <div class="w3-quarter w3-container">
                    ...
                    <div class="w3-threequarter w3-container">
                        <input type="text" name="lastName" required style="width: 80%;" value="<?php echo $lastNameSaved; ?>" title="Initial capital; spaces, apostrophes,&#10;and hyphens allowed" pattern="^[A-Z][A-Za-z '-]*$">
                        <span class="w3-text-red">*</span>
                    </div>
                </div>
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-threequarter w3-container">
                        <select name="gender" required>
                            ...
                            <option value="Other" title="Or maybe do not want to disclose" <?php if ($isOther) echo "selected"; ?>>
                                Other
                            </option>
                        </select>
                        <span class="w3-text-red">*</span>
                ...
                <div class="w3-row">
                    ...
                    <div class="w3-threequarter w3-container">
                        <input type="text" name="email" required style="width: 80%;" value="<?php echo $emailSaved; ?>" title="x@y.z, with . or - allowed in x and/or y,
and z must have only 2 or 3 letters" placeholder="Must be unique within our database" pattern="^\w+([.-]?\w+)*@\w+([.-]?\w+)*(\.\w{2,3})$">
                        <span class="w3-text-red">*</span>
                    </div>
                </div>
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-threequarter w3-container w3-wide">
                        <input type="text" name="phone" style="width: 80%;" value="<?php echo $phoneSaved; ?>" title="xxx-yyy-zzzz, (xxx)yyy-zzzz or just yyy-zzzz" pattern="((\d{3}-)?\d{3}-\d{4})|\(\d{3}\)\d{3}-\d{4}">
                    </div>
                </div>
                <div class="w3-row">
                    <div class="w3-quarter w3-container">
                    ...
                    <div class="w3-threequarter w3-container w3-wide">
                        <input type="text" name="street" required style="width: 80%;" value="<?php echo $streetSaved; ?>">
                        <span class="w3-text-red">*</span>
                    </div>
                </div>
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-threequarter w3-container w3-wide">
                        <input type="text" name="city" required style="width: 80%;" value="<?php echo $citySaved; ?>">
                        <span class="w3-text-red">*</span>
                    </div>
                </div>
                <div class="w3-row">
                    ...
                    <div class="w3-threequarter w3-container">
                        <select name="region" required style="width: 30%">
                            <option value="<?php echo $regionSaved; ?>">
                                Choose one
                            </option>
                ...
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-threequarter w3-container w3-wide">
                        <input type="text" name="postalCode" required style="width: 30%;" value="<?php echo $postalCodeSaved; ?>" title="A1B2C3 or A1B 2C3" pattern="[A-Z]\d[A-Z] ?\d[A-Z]\d">
                        <span class="w3-text-red">*</span>
                    </div>
                </div>
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-threequarter w3-container w3-wide">
                        <input type="text" name="loginName" required style="width: 80%;" value="<?php echo $loginNameSaved; ?>" title="Must start with a letter, contain
only letters and digits, and be
6 to 15 characters in length" placeholder="Choose your preferred username for login" pattern="[A-Za-z][A-Za-z0-9]{5,14}">
                        <span class="w3-text-red">*</span>
                    </div>
                </div>
                <div class="w3-row">
                    ...
                    <div class="w3-threequarter w3-container w3-wide">
                        <input type="password" name="password1" required style="width: 80%;" value="<?php echo $password1Saved; ?>" title="8 to 15 characters, including at least one
uppercase letter, one lowercase letter, one digit and
one special character from the group @^_+=[]:" placeholder="Choose a good, strong password" pattern="(?=.*\d)(?=.*[@^_+=[\]:])(?=.*[A-Z])(?=.*[a-z])\S{8,15}">
                        <span class="w3-text-red">*</span>
                    </div>
                </div>
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-threequarter w3-container w3-wide">
                        <input type="password" name="password2" required style="width: 80%;" value="<?php echo $password2Saved; ?>" placeholder="Re-enter same password as above">
                        <span class="w3-text-red">*</span>
                    </div>
                </div>
                <div class="w3-row w3-section">
